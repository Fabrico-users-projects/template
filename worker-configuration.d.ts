/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8e23520a540ad05afdb5f3b46314662f)
...
declare namespace Cloudflare {
	...
	interface Env {
		STORAGE: R2Bucket;
		ASSETS: Fetcher;
		FABRICO_API_TOKEN: string;
		FABRICO_PROJECT_ID: string;
		ENVIRONMENT: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FABRICO_API_TOKEN" | "FABRICO_PROJECT_ID" | "ENVIRONMENT">> {}
}
