/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4913d9f457bb6da057041e6fa4aefb2d)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		STORAGE: Service /* entrypoint FabricoStorage from fabrico-supervisor */;
		SOCKET: Service /* entrypoint FabricoSocket from fabrico-supervisor */;
		AI: Service /* entrypoint FabricoAI from fabrico-supervisor */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "NEON_AUTH_URL">> {}
}
